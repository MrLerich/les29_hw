...
class UserListView(ListView):
    ...
    def get(self, request, *args, **kwargs) -> JsonResponse:
        ...
        self.object_list = self.object_list.order_by('username')  # по алфавиту==прямой порядок
...
class UserDeleteView(DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        return JsonResponse({'status': 'ok. user delete successfully'}, status=204)
